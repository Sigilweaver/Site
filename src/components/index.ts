...
export { siteNavConfig, loomNavConfig, loomSimpleNavConfig, openyxdbNavConfig, opentfrawNavConfig, opentimstdfNavConfig, openwrawNavConfig, type NavConfig, type NavLink } from './config';
